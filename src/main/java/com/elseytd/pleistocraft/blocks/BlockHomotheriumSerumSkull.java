...
public class BlockHomotheriumSerumSkull extends BlockContainer {
	...
	public BlockHomotheriumSerumSkull(Material material) {
		super(material);
		this.drop = ItemsRegistry.homotherium_serum_skull;
        this.meta = 0;
        this.least_quantity = 1;
        this.most_quantity = 1;
		this.setUnlocalizedName("block_homotherium_serum_skull");
		this.setRegistryName(Reference.MOD_ID + ":" + "block_homotherium_serum_skull");
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityHomotheriumSerumSkull();
	}
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack){
		...
		if (te != null && te instanceof TileEntityHomotheriumSerumSkull) {
			TileEntityHomotheriumSerumSkull facedte = (TileEntityHomotheriumSerumSkull) te;
