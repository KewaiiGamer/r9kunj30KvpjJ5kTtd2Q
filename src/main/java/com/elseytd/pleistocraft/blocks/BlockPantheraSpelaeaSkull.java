...
public class BlockPantheraSpelaeaSkull extends BlockContainer {
	...
	public BlockPantheraSpelaeaSkull(Material material) {
		super(material);
		this.drop = ItemsRegistry.panthera_spelaea_skull;
        this.meta = 0;
        this.least_quantity = 1;
        this.most_quantity = 1;
		this.setUnlocalizedName("block_panthera_spelaea_skull");
		this.setRegistryName(Reference.MOD_ID + ":" + "block_panthera_spelaea_skull");
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityPantheraSpelaeaSkull();
	}
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack){
		...
		if (te != null && te instanceof TileEntityPantheraSpelaeaSkull) {
			TileEntityPantheraSpelaeaSkull facedte = (TileEntityPantheraSpelaeaSkull) te;
