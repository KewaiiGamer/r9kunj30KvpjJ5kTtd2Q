...
public class BlockCanisDirusSkull extends BlockContainer {
	...
	public BlockCanisDirusSkull(Material material) {
		super(material);
		this.drop = ItemsRegistry.canis_dirus_skull;
        this.meta = 0;
        this.least_quantity = 1;
        this.most_quantity = 1;
		this.setUnlocalizedName("block_canis_dirus_skull");
		this.setRegistryName(Reference.MOD_ID + ":" + "block_canis_dirus_skull");
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityCanisDirusSkull();
	}
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack){
		...
		if (te != null && te instanceof TileEntityCanisDirusSkull) {
			TileEntityCanisDirusSkull facedte = (TileEntityCanisDirusSkull) te;
