...
public class BlockSmilodonPopulatorSkull extends BlockContainer {
	...
	public BlockSmilodonPopulatorSkull(Material material) {
		super(material);
		this.drop = ItemsRegistry.smilodon_populator_skull;
        this.meta = 0;
        this.least_quantity = 1;
        this.most_quantity = 1;
		this.setUnlocalizedName("block_smilodon_populator_skull");
		this.setRegistryName(Reference.MOD_ID + ":" + "block_smilodon_populator_skull");
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntitySmilodonPopulatorSkull();
	}
