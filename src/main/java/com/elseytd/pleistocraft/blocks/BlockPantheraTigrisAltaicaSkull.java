...
public class BlockPantheraTigrisAltaicaSkull extends BlockContainer {
	...
	public BlockPantheraTigrisAltaicaSkull(Material material) {
		super(material);
		this.drop = ItemsRegistry.panthera_tigris_altaica_skull;
        this.meta = 0;
        this.least_quantity = 1;
        this.most_quantity = 1;
		this.setUnlocalizedName("block_panthera_tigris_altaica_skull");
		this.setRegistryName(Reference.MOD_ID + ":" + "block_panthera_tigris_altaica_skull");
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityPantheraTigrisAltaicaSkull();
	}
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack){
		...
		if (te != null && te instanceof TileEntityPantheraTigrisAltaicaSkull) {
			TileEntityPantheraTigrisAltaicaSkull facedte = (TileEntityPantheraTigrisAltaicaSkull) te;
