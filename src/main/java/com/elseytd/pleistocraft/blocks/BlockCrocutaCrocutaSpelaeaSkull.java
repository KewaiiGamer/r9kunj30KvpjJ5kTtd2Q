...
public class BlockCrocutaCrocutaSpelaeaSkull extends BlockContainer {
	...
	public BlockCrocutaCrocutaSpelaeaSkull(Material material) {
		super(material);
		this.drop = ItemsRegistry.crocuta_crocuta_spelaea_skull;
        this.meta = 0;
        this.least_quantity = 1;
        this.most_quantity = 1;
		this.setUnlocalizedName("block_crocuta_crocuta_spelaea_skull");
		this.setRegistryName(Reference.MOD_ID + ":" + "block_crocuta_crocuta_spelaea_skull");
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityCrocutaCrocutaSpelaeaSkull();
	}
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack){
		...
		if (te != null && te instanceof TileEntityCrocutaCrocutaSpelaeaSkull) {
			TileEntityCrocutaCrocutaSpelaeaSkull facedte = (TileEntityCrocutaCrocutaSpelaeaSkull) te;
