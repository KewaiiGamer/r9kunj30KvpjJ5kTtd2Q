...
public class ItemPantheraTigrisAltaicaSkull extends Item {

	public ItemPantheraTigrisAltaicaSkull(String unlocalizedName) {
		super();
	...
	public boolean onItemUse(ItemStack stack, EntityPlayer playerIn,
		...
		if (worldIn.isRemote) {
			...
			if (playerIn.canPlayerEdit(pos, side, stack)
				...
				int skullRotate = 0;
				IBlockState iblockstate1 = BlocksRegistry.block_panthera_tigris_altaica_skull
						.getStateFromMeta(0);
