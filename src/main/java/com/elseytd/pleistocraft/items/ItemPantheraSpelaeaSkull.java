...
public class ItemPantheraSpelaeaSkull extends Item {

	public ItemPantheraSpelaeaSkull(String unlocalizedName) {
		super();
	...
	public EnumActionResult onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
		if (worldIn.isRemote) {
			...
			if (playerIn.canPlayerEdit(pos, side, stack)
				...
				int skullRotate = 0;
				IBlockState iblockstate1 = BlocksRegistry.block_panthera_spelaea_skull
						.getStateFromMeta(0);
