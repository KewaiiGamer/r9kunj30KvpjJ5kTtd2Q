...
public class ItemCanisDirusSkull extends Item {

	public ItemCanisDirusSkull(String unlocalizedName) {
		super();
	...
	public EnumActionResult onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
		if (worldIn.isRemote) {
			...
			if (playerIn.canPlayerEdit(pos, side, stack)
				...
				int skullRotate = 0;
				IBlockState iblockstate1 = BlocksRegistry.block_canis_dirus_skull
						.getStateFromMeta(0);
				...
				if (te != null && te instanceof TileEntityCanisDirusSkull) {
					...
					TileEntityCanisDirusSkull entityCanisDirusSkull = (TileEntityCanisDirusSkull) te;
					facedte.setFacing(facing);

					//worldIn.spawnEntityInWorld(facedte);
