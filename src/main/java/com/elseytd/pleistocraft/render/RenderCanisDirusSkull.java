...
import com.elseytd.pleistocraft.models.ModelCanisDirusSkull;

public class RenderCanisDirusSkull extends TileEntitySpecialRenderer {

	private final ModelCanisDirusSkull model;
	private final String TextureLocation = Reference.MOD_ID + ":textures/blocks/canis_dirus_skull.png";
	
	public RenderCanisDirusSkull() {
		this.model = new ModelCanisDirusSkull();
	}
	...
	public void renderTileEntityAt(TileEntity te, double x, double y, double z, float partialTicks, int destroyStage) {
		...
		TileEntityCanisDirusSkull facedEntity = (TileEntityCanisDirusSkull) te;
