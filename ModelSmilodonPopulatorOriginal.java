...
public class ModelSmilodonPopulators.back extends ModelBase{
   ...
   @Override
	...
	float swingamt = 0.8F;
        this.LegRB.rotateAngleX = MathHelper.cos(p_78087_1_ * 0.6662F) * swingamt * p_78087_2_;
        this.LegLB.rotateAngleX = MathHelper.cos(p_78087_1_ * 0.6662F + (float)Math.PI) * 1F * p_78087_2_;
        this.LegRF.rotateAngleX = MathHelper.cos(p_78087_1_ * 0.6662F + (float)Math.PI) * 1F * p_78087_2_;
        this.LegLF.rotateAngleX = MathHelper.cos(p_78087_1_ * 0.6662F) * swingamt * p_78087_2_;
